...
void loop() {
  ...
  else if(0x02 == TC_CH4.status){Serial.print("SHORT TO GND");}
  else if(0x04 == TC_CH4.status){Serial.print("SHORT TO Vcc");}
  else{Serial.print("unknown fault");}
  ...
  else if(0x02 == TC_CH5.status){Serial.print("SHORT TO GND");}
  else if(0x04 == TC_CH5.status){Serial.print("SHORT TO Vcc");}
  else{Serial.print("unknown fault");}
  ...
  else if(0x02 == TC_CH6.status){Serial.print("SHORT TO GND");}
  else if(0x04 == TC_CH6.status){Serial.print("SHORT TO Vcc");}
  else{Serial.print("unknown fault");}
  ...
  else if(0x02 == TC_CH7.status){Serial.print("SHORT TO GND");}
  else if(0x04 == TC_CH7.status){Serial.print("SHORT TO Vcc");}
  else{Serial.print("unknown fault");}
